          ...
          >
            {[
              ...
              <motion.div key={index} variants={slideUp} className={iconHoverStyles}>
                <Link href={url} target="_blank" className="w-full h-full flex items-center justify-center">
                  {/* Glass Background */}
                  <motion.div
                  ...
                  >
                    ...
                    <div className="relative overflow-hidden h-5">
                      <span
                        className="text-sm text-white transform translate-y-[-10px] opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 font-medium"
                      >
                        {name}
                      </span>
                    </div>
